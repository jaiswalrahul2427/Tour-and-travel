...
const Footer = () => {
  return (
    <>
      <div className="relative py-10 overflow-hidden  dark:bg-gray-950">
        <video
          autoPlay
          loop
          muted
        ...
        <div className="container">
          <div className="grid py-5 md:grid-cols-3 bg-white/80 backdrop-blur-sm rounded-t-xl">
          ...
          <div>
            <div className="py-5 text-center text-white border-t-2 border-gray-300/50 bg-primary">
              @copyright 2024 All rights reserved || Made By Rahul
            </div>
          </div>
        </div>
      </div>
